"""
Limit more use of UnsafePointer through lifetime and Span

Run:
    mojo ngram_v03.mojo
OR
    mojo build ngram_v03.mojo && ./ngram_v03
"""
...
struct NgramModel:
    ...
    @staticmethod
    fn ravel_index(index: UnsafePointer[c_int], n: c_int, dim: c_int) raises -> c_size_t:
        var index1d = 0
        var multiplier = 1
    ...
    fn train(inout self, tape: Span[c_int, _]) raises:
        var offset = self.ravel_index(tape.unsafe_ptr(), self.seq_len, self.vocab_size)
        debug_assert(
