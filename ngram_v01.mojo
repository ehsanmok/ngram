"""
Fix dangling pointer and make the use of uninitialized memory buffer safe

Run:
    mojo ngram_v01.mojo
OR
    mojo build ngram_v01.mojo && ./ngram_v01
"""
...
fn fclose(inout stream: UnsafePointer[FILE]) raises:
